...
var KTModalCreateProject = function () {
    ...
    return {
        init: function () {
            e = document.querySelector("#kt_modal_create_project_stepper"), o = document.querySelector("#kt_modal_create_project_form"), t = new KTStepper(e)
        },
...
})), "undefined" != typeof module && void 0 !== module.exports && (window.KTModalCreateProject = module.exports = KTModalCreateProject);