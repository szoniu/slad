...
if (n.contentElement && "menu" === n.layout) {
    ...
    if (n.menuObject) {
        if (n.toggleElement) {
            ...
            n.menuObject.on("kt.menu.dropdown.show", function(e) {
                if (KTUtil.visible(n.toggleElement)) {
    ...
    window.addEventListener("resize", function() {
        KTUtil.throttle(undefined, function() {
            ...
            m = function () {
                if ("menu" === n.layout) {
                    var e = T();
            "on" === e && n.contentElement && !1 === n.contentElement.contains(n.formElement) ? (n.contentElement.prepend(n.formElement), n.formElement.classList.remove("d-none")) : "off" === e && n.contentElement && !0 === n.contentElement.contains(n.formElement) && (n.element.prepend(n.formElement), n.formElement.classList.add("d-none"))
                }
            },
            f = function () {
